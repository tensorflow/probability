...
class LinearOperatorIdentity(BaseLinearOperatorIdentity):
  ...
  # Note that tensor_shape.TensorShape(y.shape) is compatible with tensor_shape.TensorShape(operator.shape) because tensor_shape.TensorShape(operator.shape)
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  def _possibly_broadcast_batch_shape(self, x):
    ...
    bshape = _ops.broadcast_static_shape(tensor_shape.TensorShape(x.shape), special_shape)
