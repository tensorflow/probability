...
from tensorflow_probability.python.experimental.inference_gym.targets import log_gaussian_cox_process
...
class LogGaussianCoxProcessTest(test_util.InferenceGymTestCase,
  ...
  def testSyntheticLogGaussianCoxProcessHMC(self):
    ...
    self.validate_ground_truth_using_hmc(
        ...
        step_size=0.001,
        dtype=tf.float64,
        use_xla=JAX_MODE,  # TF XLA is very slow on this problem
    )
