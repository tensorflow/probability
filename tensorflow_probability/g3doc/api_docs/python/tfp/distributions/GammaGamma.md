...
Defined in [`python/distributions/gamma_gamma.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/gamma_gamma.py).
