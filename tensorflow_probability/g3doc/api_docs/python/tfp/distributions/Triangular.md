...
Defined in [`python/distributions/triangular.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/triangular.py).
