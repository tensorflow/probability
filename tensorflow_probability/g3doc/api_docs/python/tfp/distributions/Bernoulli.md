...
Defined in [`python/distributions/bernoulli.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/bernoulli.py).
