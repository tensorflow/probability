...
<meta itemprop="name" content="tfp.distributions.LKJ" />
...
Defined in [`python/distributions/lkj.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/lkj.py).
