...
Defined in [`python/distributions/truncated_normal.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/truncated_normal.py).
