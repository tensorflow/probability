...
Defined in [`python/distributions/negative_binomial.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/negative_binomial.py).
