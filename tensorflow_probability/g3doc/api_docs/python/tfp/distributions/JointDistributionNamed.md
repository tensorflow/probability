...
Defined in [`python/distributions/joint_distribution_named.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/joint_distribution_named.py).
...
**Note**: unlike other non-`JointDistribution` distributions in
<a href="../../tfp/distributions.md"><code>tfp.distributions</code></a>, `JointDistributionNamed.sample` (and subclasses) return a
