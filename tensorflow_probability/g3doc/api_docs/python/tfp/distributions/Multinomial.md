...
Defined in [`python/distributions/multinomial.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/multinomial.py).
