...
Defined in [`python/distributions/dirichlet_multinomial.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/dirichlet_multinomial.py).
