...
Defined in [`python/distributions/mvn_diag_plus_low_rank.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/mvn_diag_plus_low_rank.py).
