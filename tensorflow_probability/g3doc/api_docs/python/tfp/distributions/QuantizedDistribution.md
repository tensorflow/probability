...
Defined in [`python/distributions/quantized_distribution.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/quantized_distribution.py).
