...
Defined in [`python/distributions/multivariate_student_t.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/multivariate_student_t.py).
