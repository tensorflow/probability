...
Defined in [`python/distributions/independent.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/independent.py).
