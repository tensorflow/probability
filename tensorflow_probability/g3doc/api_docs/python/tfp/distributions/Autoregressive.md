...
# tfp.distributions.Autoregressive
...
Defined in [`python/distributions/autoregressive.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/autoregressive.py).
