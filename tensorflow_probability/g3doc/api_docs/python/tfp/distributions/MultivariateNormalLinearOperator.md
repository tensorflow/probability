...
Defined in [`python/distributions/mvn_linear_operator.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/mvn_linear_operator.py).
