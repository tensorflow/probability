...
<meta itemprop="name" content="tfp.distributions.HalfCauchy" />
...
Defined in [`python/distributions/half_cauchy.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/half_cauchy.py).
