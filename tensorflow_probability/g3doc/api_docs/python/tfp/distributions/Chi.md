...
<meta itemprop="name" content="tfp.distributions.Chi" />
...
Defined in [`python/distributions/chi.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/chi.py).
