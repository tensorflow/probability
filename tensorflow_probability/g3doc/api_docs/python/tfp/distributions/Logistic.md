...
<meta itemprop="name" content="tfp.distributions.Logistic" />
...
Defined in [`python/distributions/logistic.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/logistic.py).
