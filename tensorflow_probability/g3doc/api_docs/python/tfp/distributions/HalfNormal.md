...
Defined in [`python/distributions/half_normal.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/half_normal.py).
