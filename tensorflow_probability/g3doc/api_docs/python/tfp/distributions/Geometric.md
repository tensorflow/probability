...
Defined in [`python/distributions/geometric.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/geometric.py).
