...
Defined in [`python/distributions/mixture_same_family.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/mixture_same_family.py).
