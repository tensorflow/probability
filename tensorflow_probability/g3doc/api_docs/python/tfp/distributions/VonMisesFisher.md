...
Defined in [`python/distributions/von_mises_fisher.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/von_mises_fisher.py).
