...
Defined in [`python/distributions/empirical.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/empirical.py).
