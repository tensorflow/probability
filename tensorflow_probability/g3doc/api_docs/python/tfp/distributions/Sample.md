...
<meta itemprop="name" content="tfp.distributions.Sample" />
...
Defined in [`python/distributions/sample.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/sample.py).
