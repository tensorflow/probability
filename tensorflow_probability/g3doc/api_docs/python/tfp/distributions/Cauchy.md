...
<meta itemprop="name" content="tfp.distributions.Cauchy" />
...
Defined in [`python/distributions/cauchy.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/cauchy.py).
