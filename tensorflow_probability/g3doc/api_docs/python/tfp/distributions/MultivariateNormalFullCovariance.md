...
<meta itemprop="name" content="tfp.distributions.MultivariateNormalFullCovariance" />
...
Inherits From: [`MultivariateNormalTriL`](../../tfp/distributions/MultivariateNormalTriL.md)



Defined in [`python/distributions/mvn_full_covariance.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/mvn_full_covariance.py).
