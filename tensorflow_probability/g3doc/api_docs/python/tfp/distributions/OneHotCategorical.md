...
Defined in [`python/distributions/onehot_categorical.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/onehot_categorical.py).
