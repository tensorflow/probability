...
<meta itemprop="name" content="tfp.distributions.VonMises" />
...
Defined in [`python/distributions/von_mises.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/von_mises.py).
...
`other` types with built-in registrations: `VonMises`
...
Additional documentation from `VonMises`:
