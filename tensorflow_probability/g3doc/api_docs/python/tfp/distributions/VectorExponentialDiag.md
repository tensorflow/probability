...
Defined in [`python/distributions/vector_exponential_diag.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/vector_exponential_diag.py).
