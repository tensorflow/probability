...
<meta itemprop="name" content="tfp.distributions.Laplace" />
...
Defined in [`python/distributions/laplace.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/laplace.py).
