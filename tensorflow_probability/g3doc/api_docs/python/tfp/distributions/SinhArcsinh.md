...
Defined in [`python/distributions/sinh_arcsinh.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/sinh_arcsinh.py).
