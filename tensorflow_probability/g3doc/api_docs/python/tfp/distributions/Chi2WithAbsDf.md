...
<meta itemprop="name" content="tfp.distributions.Chi2WithAbsDf" />
...
# tfp.distributions.Chi2WithAbsDf

## Class `Chi2WithAbsDf`

Chi2 with parameter transform `df = floor(abs(df))`.

Inherits From: [`Chi2`](../../tfp/distributions/Chi2.md)



Defined in [`python/distributions/chi2.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/chi2.py).
...
`other` types with built-in registrations: `Chi2`, `Chi2WithAbsDf`, `Exponential`, `Gamma`
