...
Defined in [`python/distributions/categorical.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/distributions/categorical.py).
