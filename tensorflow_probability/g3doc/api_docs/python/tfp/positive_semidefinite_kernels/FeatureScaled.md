...
Defined in [`python/positive_semidefinite_kernels/feature_scaled.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/positive_semidefinite_kernels/feature_scaled.py).
