...
<meta itemprop="name" content="tfp.layers.DistributionLambda" />
...
* Class `tfp.layers.DistributionLambda`
* Class `tfp.layers.distribution_layer.DistributionLambda`
...
a <a href="../../tfp/distributions/Distribution.md"><code>tfp.distributions.Distribution</code></a> instance.

Since subsequent Keras layers are functions of tensors, a `DistributionLambda`
also defines how the <a href="../../tfp/distributions/Distribution.md"><code>tfp.distributions.Distribution</code></a> shall be "concretized"
as a tensor. By default, a distribution is represented as a tensor via a
random draw, e.g., <a href="../../tfp/distributions/Distribution.md#sample"><code>tfp.distributions.Distribution.sample</code></a>. Alternatively the
...
* <b>`make_distribution_fn`</b>: Python `callable` that takes previous layer outputs
