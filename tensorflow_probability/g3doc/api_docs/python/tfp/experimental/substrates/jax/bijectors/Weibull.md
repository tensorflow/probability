...
<meta itemprop="name" content="tfp.experimental.substrates.jax.bijectors.Weibull" />
...
# tfp.experimental.substrates.jax.bijectors.Weibull


<table class="tfo-notebook-buttons tfo-api" align="left">

<td>
  <a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/jax/bijectors/weibull.py">
...
<a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/jax/bijectors/weibull.py">View source</a>
...
* <b>`scale`</b>: Positive Float-type `Tensor` that is the same dtype and is
  broadcastable with `concentration`.
  This is `l` in `Y = g(X) = 1 - exp((-x / l) ** k)`.
* <b>`concentration`</b>: Positive Float-type `Tensor` that is the same dtype and is
