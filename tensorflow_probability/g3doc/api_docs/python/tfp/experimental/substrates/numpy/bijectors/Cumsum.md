...
<meta itemprop="name" content="tfp.experimental.substrates.numpy.bijectors.Cumsum" />
...
# tfp.experimental.substrates.numpy.bijectors.Cumsum


<table class="tfo-notebook-buttons tfo-api" align="left">

<td>
  <a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/bijectors/cumsum.py">
...
<a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/bijectors/cumsum.py">View source</a>
...
* <b>`axis`</b>: Negative Python `int` indicating the axis along which to compute the
...
* <b>`TypeError`</b>: if `axis` is not an `int`.
* <b>`ValueError`</b>: if `axis` is not negative.
