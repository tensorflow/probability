...
<meta itemprop="name" content="tfp.experimental.substrates.numpy.distributions.ProbitBernoulli" />
...
<meta itemprop="property" content="probits"/>
...
<meta itemprop="property" content="probits_parameter"/>
...
# tfp.experimental.substrates.numpy.distributions.ProbitBernoulli


<table class="tfo-notebook-buttons tfo-api" align="left">

<td>
  <a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/distributions/probit_bernoulli.py">
...
<h3 id="probits"><code>probits</code></h3>
...
`other` types with built-in registrations: `ProbitBernoulli`
...
Additional documentation from `ProbitBernoulli`:
...
<h3 id="probits_parameter"><code>probits_parameter</code></h3>

<a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/distributions/probit_bernoulli.py">View source</a>

``` python
probits_parameter(name=None)
```
