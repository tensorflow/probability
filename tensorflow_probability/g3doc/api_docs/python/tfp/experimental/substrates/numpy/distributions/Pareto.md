...
<meta itemprop="name" content="tfp.experimental.substrates.numpy.distributions.Pareto" />
...
# tfp.experimental.substrates.numpy.distributions.Pareto


<table class="tfo-notebook-buttons tfo-api" align="left">

<td>
  <a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/distributions/pareto.py">
...
`other` types with built-in registrations: `Pareto`
...
Additional documentation from `Pareto`:
