...
<meta itemprop="name" content="tfp.experimental.substrates.numpy.bijectors.Pad" />
<meta itemprop="path" content="Stable" />
<meta itemprop="property" content="axis"/>
<meta itemprop="property" content="constant_values"/>
...
<meta itemprop="property" content="paddings"/>
...
# tfp.experimental.substrates.numpy.bijectors.Pad


<table class="tfo-notebook-buttons tfo-api" align="left">

<td>
  <a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/bijectors/pad.py">
...
The semantics of <a href="../../../../../tfp/bijectors/Pad.md"><code>tfp.bijectors.Pad</code></a> generally follow that of `tf.pad()`
except that <a href="../../../../../tfp/bijectors/Pad.md"><code>tfp.bijectors.Pad</code></a>'s `paddings` argument applies to the rightmost
...
<a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/bijectors/pad.py">View source</a>
...
* <b>`paddings`</b>: A vector-shaped `Tensor` of `int` pairs representing the number
...
* <b>`axis`</b>: The dimensions for which `paddings` are applied. Must be 1:1 with
  `paddings` or `None`.
...
<h3 id="constant_values"><code>constant_values</code></h3>
...
<h3 id="paddings"><code>paddings</code></h3>
