...
<meta itemprop="name" content="tfp.experimental.substrates.numpy.distributions.Beta" />
...
# tfp.experimental.substrates.numpy.distributions.Beta


<table class="tfo-notebook-buttons tfo-api" align="left">

<td>
  <a target="_blank" href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/python/experimental/substrates/numpy/distributions/beta.py">
...
Sum of concentration parameters. (deprecated)

Warning: THIS FUNCTION IS DEPRECATED. It will be removed after 2019-10-01.
Instructions for updating:
The `total_concentration` property is deprecated; instead use `dist.concentration1 + dist.concentration0`.
