...
Defined in [`python/bijectors/batch_normalization.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/bijectors/batch_normalization.py).
