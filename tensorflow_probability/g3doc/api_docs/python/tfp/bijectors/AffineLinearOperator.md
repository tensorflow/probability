...
Defined in [`python/bijectors/affine_linear_operator.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/bijectors/affine_linear_operator.py).
