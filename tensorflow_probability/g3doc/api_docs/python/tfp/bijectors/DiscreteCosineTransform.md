...
Defined in [`python/bijectors/discrete_cosine_transform.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/bijectors/discrete_cosine_transform.py).
