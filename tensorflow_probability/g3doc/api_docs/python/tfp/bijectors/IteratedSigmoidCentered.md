...
Defined in [`python/bijectors/iterated_sigmoid_centered.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/bijectors/iterated_sigmoid_centered.py).
