...
Defined in [`python/bijectors/matrix_inverse_tril.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/bijectors/matrix_inverse_tril.py).
