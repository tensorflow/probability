...
Defined in [`python/bijectors/cholesky_outer_product.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/bijectors/cholesky_outer_product.py).
