...
Defined in [`python/bijectors/transform_diagonal.py`](https://github.com/tensorflow/probability/tree/master/tensorflow_probability/python/bijectors/transform_diagonal.py).
