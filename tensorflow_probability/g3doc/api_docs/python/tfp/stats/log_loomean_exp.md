...
<meta itemprop="name" content="tfp.stats.log_loomean_exp" />
<meta itemprop="path" content="Stable" />
</div>

# tfp.stats.log_loomean_exp
...
* <b>`log_loomean_exp`</b>: `Tensor` with same shape and dtype as `logx` representing
