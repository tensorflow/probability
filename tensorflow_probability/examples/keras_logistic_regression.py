...
class ToyDataSequence(tf.keras.utils.Sequence):
    '''
    Class inheriting from the Keras Sequence class for creating
    a sequence of data (to be used with a model.fit_generator
    function).
...
def main(argv):
    ...
    if tf.io.gfile.exists(FLAGS.model_dir):
        print("Warning: deleting old log directory at {}".format(
            FLAGS.model_dir))
