...
# ============================================================================
"""Trains a Generative adversarial network (GAN) to generate synthetic images
 of MNIST digits.

GAN is a generative model that learns the probability distribution of training
examples and generates similar samples. It simultaneously trains two models:
a generative model G that learns the data distribution, and a discriminative
...
def main(argv):
  ...
  with tf.compat.v1.name_scope('Generator'):
    random_noise = tf.placeholder(tf.float32, shape=[None, FLAGS.hidden_size])
