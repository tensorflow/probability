...
# ============================================================================
"""Utilities for interfacing with Gin configurations."""
...
__all__ = ['bind_hparams', 'YAMLDictParser']
...
def bind_hparams(hparams: Mapping[str, Any]):
  """Binds all Gin parameters from a dictionary.

  Args:
    hparams: A dictionary of bindings.
  """
